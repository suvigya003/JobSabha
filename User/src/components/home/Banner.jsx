...
const Banner = () => {
  return (
    <>
    <Box p={3} pt={10} pb={10} mt={1} ml={20} fullWidth mr={20} sx={{ borderRadius:'16px 16px 0px 0px', background:theme.palette.background.default,display:'flex',alignItems:'center',justifyContent:'center'}}>
